...
export function EnhancedSearchForm({
  ...
  // Advanced filters
  const [experienceLevel, setExperienceLevel] = useState(initialValues?.experienceLevel || 'entry_level');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const criteria: SearchCriteria = {
      ...
      // Advanced filters
      experienceLevel: experienceLevel !== 'all' ? experienceLevel as 'entry' | 'mid' | 'senior' | 'executive' : undefined,
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-gray-900 rounded-lg shadow-lg p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 bg-gray-800 rounded-lg border border-gray-700">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setExperienceLevel(e.target.value as 'entry_level' | 'early_career' | 'all')}
              ...
              <div>
                ...
                >
                  ...
                  <option value="Business_Services">Business Services & Operations</option>
                  <option value="Chemicals">Chemicals & Materials</option>
                  <option value="Clean_Energy">Clean Energy & Renewables</option>
                  <option value="Cloud_Computing">Cloud Computing & Infrastructure</option>
                  <option value="Consumer_Electronics">Consumer Electronics</option>
                  <option value="Consumer_Goods">Consumer Goods & Products</option>
                  <option value="Data_Analytics">Data Analytics & Business Intelligence</option>
                  <option value="Dental">Dental & Oral Health</option>
                  <option value="E_Learning">E-Learning & EdTech</option>
                  <option value="Electronics">Electronics & Hardware</option>
                  <option value="Engineering">Engineering Services</option>
                  <option value="Events">Events & Event Planning</option>
                  <option value="Facilities">Facilities & Property Management</option>
                  ...
                  <option value="Green_Tech">Green Technology</option>
                  <option value="Health_Tech">Health Technology & Digital Health</option>
                  ...
                  <option value="Investment_Banking">Investment Banking & Capital Markets</option>
                  ...
                  <option value="Market_Research">Market Research & Insights</option>
                  <option value="Medical_Devices">Medical Devices & Equipment</option>
                  <option value="Mobile_Apps">Mobile Apps & Development</option>
                  <option value="Music">Music & Audio Production</option>
                  <option value="Nanotechnology">Nanotechnology</option>
                  <option value="Packaging">Packaging & Label Manufacturing</option>
                  <option value="Payments">Payments & Payment Processing</option>
                  <option value="Pet_Care">Pet Care & Veterinary</option>
                  <option value="Photography">Photography & Videography</option>
                  <option value="Plastics">Plastics & Polymer Manufacturing</option>
                  <option value="PR">Public Relations & Communications</option>
                  ...
                  <option value="Regulatory">Regulatory Affairs & Compliance</option>
                  ...
                  <option value="Security_Services">Security Services & Protection</option>
                  <option value="Semiconductors">Semiconductors & Microelectronics</option>
                  <option value="Senior_Care">Senior Care & Assisted Living</option>
                  <option value="Smart_Home">Smart Home Technology</option>
                  <option value="Social_Media">Social Media & Community</option>
                  <option value="Space">Space & Satellite Technology</option>
                  <option value="Staffing">Staffing & Workforce Solutions</option>
                  <option value="Supply_Chain">Supply Chain & Logistics</option>
                  <option value="Technical_Writing">Technical Writing & Documentation</option>
                  ...
                  <option value="Waste_Management">Waste Management & Recycling</option>
                  <option value="Water_Treatment">Water Treatment & Management</option>
                  <option value="Web_Development">Web Development</option>
                  <option value="Wholesale">Wholesale & Distribution</option>
                  <option value="Wine_Spirits">Wine & Spirits</option>
                </select>
              </div>
      ...
      <div className="flex gap-3 pt-2">
        {requiresAuth && (
          <div className="flex-1 bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-700/50 rounded-lg p-3 text-center">
