  ...
  if (matches.length === 0) {
    return (
      <div className="text-center py-12">
        <h2 className="text-2xl font-bold text-gray-100 mb-4">No Matches Found</h2>
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <div>
                      ...
                      <p className="text-sm text-gray-400">{match.career.category}</p>
                    </div>
                  </div>
                </div>
              ...
              {expandedMatch === match.career.id && (
                <div className="border-t border-gray-700 pt-4 space-y-4">
                  ...
                  <div className="bg-gray-900 rounded-lg p-4 space-y-3">
                    <div>
                      <h5 className="text-xs font-semibold text-gray-300 mb-1">Interests Alignment</h5>
                      <p className="text-xs text-gray-400">{match.reasoning.interestsAlignment.explanation}</p>
                    ...
                    <div>
                      <h5 className="text-xs font-semibold text-gray-300 mb-1">Skills Match</h5>
                      <p className="text-xs text-gray-400">{match.reasoning.skillsMatch.explanation}</p>
                      ...
                      {match.reasoning.skillsMatch.missingSkills.length > 0 && (
                        <div className="mt-2">
                          <p className="text-xs text-gray-400 mb-1">Skills to Develop:</p>
                          <div className="flex flex-wrap gap-1">
                    ...
                    <div>
                      <h5 className="text-xs font-semibold text-gray-300 mb-1">Personality Fit</h5>
                      <p className="text-xs text-gray-400">{match.reasoning.personalityFit.explanation}</p>
                    </div>

                    {match.reasoning.educationFit.pathways.length > 0 && (
                      <div>
                        <h5 className="text-xs font-semibold text-gray-300 mb-1">Education Pathways</h5>
