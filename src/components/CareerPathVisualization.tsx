...
export function CareerPathVisualization({ trajectories }: CareerPathVisualizationProps) {
  ...
  return (
    <div className="mb-8">
      ...
      {/* Path Overview */}
      <div className="bg-gradient-to-br from-orange-900/30 to-blue-900/30 rounded-lg border-2 border-orange-700/40 p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div className="bg-gray-900/50 rounded-lg p-3 border border-orange-700/30">
            <div className="text-xs font-semibold text-orange-400 uppercase tracking-wide mb-2">Timeline</div>
            <div className="text-sm text-gray-300">{currentPath.estimatedTimeline}</div>
          </div>
          <div className="bg-gray-900/50 rounded-lg p-3 border border-orange-700/30">
            <div className="text-xs font-semibold text-orange-400 uppercase tracking-wide mb-2">Industry Demand</div>
        ...
        <div className="bg-orange-900/20 rounded-lg p-4 border border-orange-700/30">
          <div className="text-xs font-semibold text-orange-400 uppercase tracking-wide mb-2">Why This Path Fits You</div>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {/* Senior Role */}
          <div className="bg-gray-800 rounded-lg border border-orange-700/50 p-5 relative">
            <div className="absolute top-3 right-3 w-8 h-8 bg-orange-600 rounded-full flex items-center justify-center text-white font-bold text-sm">
              3
            </div>
            <div className="mb-3">
              ...
              <p className="text-sm text-orange-400 font-semibold mt-1">{currentPath.seniorRole.salary}</p>
            </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1">
                  {currentPath.seniorRole.requiredSkills.map((skill, idx) => (
                    <span key={idx} className="px-2 py-0.5 bg-orange-900/30 text-orange-300 rounded text-xs">
                      {skill}
                    </span>
                  ))}
                </div>
      ...
      <div>
        ...
        <div className="bg-gray-800 rounded-lg border border-orange-700/30 p-5">
          <div className="space-y-3">
            {currentPath.skillDevelopment.map((milestone, index) => (
              <div key={index} className="flex items-start gap-4">
                <div className="flex-shrink-0 w-32">
                  <div className="text-xs font-semibold text-orange-400">{milestone.timeframe}</div>
