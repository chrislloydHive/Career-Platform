        ...
        <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            {stats.filtered !== stats.total && (
              <span className="text-sm text-gray-500">of {stats.total}</span>
            )}
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50 text-gray-700"
                >
                  Reset Filters
                </button>
              </div>
              ...
              <button
                ...
                className={`absolute top-4 right-4 z-10 p-2 rounded-full transition-all ${
                  savedJobIds.includes(job.id)
                    ...
                    : 'bg-white text-gray-400 hover:bg-gray-100 hover:text-yellow-600'
                }`}
